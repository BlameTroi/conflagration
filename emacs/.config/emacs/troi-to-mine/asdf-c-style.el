;;; troi-c-style.el --- troi's c style for c-mode
...
(defun troi-make-newline-indent ()
  "Sets up preferred newline behavior. Not set by default."
  (interactive)
...
;; i got this by having cc mode guess the style of kilo.c after it had been
;; reformatted by my astyle definition, which looks like this (from .astylerc):
;;
;;
