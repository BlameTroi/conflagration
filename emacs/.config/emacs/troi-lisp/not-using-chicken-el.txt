;;; chicken.el - Scheme mode modified for use with Chicken -*- lexical-binding: t; -*-
...
;; This and flymake-chicken.el were downloaded from the Chicken Scheme
...
;; Loading _Simply_Scheme_ support files:
;; TODO: SICP.
(define-key scheme-mode-map "\C-c\C-s" 'chicken-load-simply-scheme)
(define-key scheme-mode-map "\C-c\C-f" 'chicken-load-simply-functions)
...
(defun chicken-load-simply-scheme (&optional switch)
  (interactive "P")
  (comint-send-string
  (scheme-proc)
  "(load \"/Users/troi/Projects/Scheme/Simply_Scheme/simply.scm\")")
    (if switch
      (switch-to-scheme t)
      (message " loaded simply.scm.")))

(defun chicken-load-simply-functions (&optional switch)
  (interactive "P")
  (comint-send-string
  (scheme-proc)
  "(load \"/Users/troi/Projects/Scheme/Simply_Scheme/functions.scm\")")
    (if switch
      (switch-to-scheme t)
      (message " loaded simply.scm.")))
